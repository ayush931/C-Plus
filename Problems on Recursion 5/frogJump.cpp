// There are N stones, numbered 1, 2, ...., N. For each i (1 <= i <= N), the height of the stone i is hi. There is a frog who is initially on Stone 1. He will repeat the following action some number of times to reach Stone N:
